        ...
        <div className="p-6 space-y-4">
          ...
          {salario>0 && (
            <div className="bg-slate-50 rounded-xl p-3 space-y-1 text-xs">
              ...
              <div className="flex justify-between font-bold border-t border-slate-200 pt-1"><span>Salario neto a pagar</span><span className="text-emerald-700">{fmtMoney(salarioNeto,"CRC")}</span></div>
            </div>
          )}
          <div className="grid grid-cols-2 gap-3">
            <div>
      ...
      <div className="flex-1 overflow-auto p-6">
        {filtrados.length===0 ? (
          ...
          <div className="space-y-2">
            {filtrados.map(e=>(
              <div key={e.id} className="bg-white border border-slate-200 rounded-xl px-5 py-3.5 flex items-center gap-4 hover:border-emerald-300 group">
