        ...
        {subiendo ? (
          ...
          <div className="flex flex-col items-center gap-2 text-slate-400">
            ...
            <p className="text-sm font-medium text-slate-600">
              Arrastrá archivos <span className="font-mono text-green-700">.xml</span> aquí, o hacé click para seleccionarlos
            </p>
                      ...
                      {esPend ? (
                        <div className="flex items-center justify-center gap-1">
                          <button
                            ...
                            disabled={proc}
                            title="Aceptar"
                            className="flex items-center gap-1 px-2.5 py-1 bg-green-100 text-green-700 rounded-lg text-xs font-semibold hover:bg-green-200 disabled:opacity-50">
