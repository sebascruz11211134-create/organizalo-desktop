          ...
          <label className="block">
            ...
            <div className="relative mt-1">
              <input type={showPin?"text":"password"} value={form.pin} onChange={e=>u("pin",e.target.value.slice(0,4))}
                ...
                className="w-full border border-slate-200 rounded-md px-3 py-2 text-sm pr-10 focus:outline-none focus:ring-1 focus:ring-brand-400"/>
                ...
                {usuarios.map(u=>{
                  ...
                  return (
                    <tr key={u.id}>
                      ...
                      <td>
                        <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${u.activo?"bg-green-50 text-green-700":"bg-slate-100 text-slate-400"}`}>
